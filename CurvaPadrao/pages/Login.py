...
class FirebaseManager:
    def __init__(self):
        ...
        self.firebase_apiKey ="XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
...
class Login(Container):
    ...
    def login_me(self, e):
            ...
            if token:
                ...
                self.store_email(self.email_box.content.value)
    ...
    def store_email(self,email):
        if os.path.exists('email.pickle'):
            os.remove('email.pickle')
        with open('email.pickle', 'wb') as fb:
            pickle.dump(email,fb)